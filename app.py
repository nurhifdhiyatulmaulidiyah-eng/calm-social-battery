...
# =============================================================================
    ...
    try:
        ...
        * **`social_intensity_score`** Memiliki rata-rata sebesar **43.4** dengan puncak tertinggi di angka **75.8**. Ini mencerminkan bahwa tingkat kepadatan atau beban aktivitas sosial pengguna dominan berada di level menengah (Medium Intensity), menjaga agar mayoritas data tetap berada di level Medium Battery.
        """)
        st.divider()
